...
class Data:
    ...
    def generate_data(self, batch_size, hist_size):

        # randomly select batch_size entries
        x = np.zeros((batch_size, (self.num_vars+1)*hist_size-1), dtype = np.float32)
        ...
        for i in range(batch_size):
            ...
            ind_hist = ind_preceeding[ind_hist[:hist_size-1]]
